...
public class FluidFilterScreen extends AbstractPipeGui<FluidFilterContainer> {

    public FluidFilterScreen(FluidFilterContainer screenContainer, Inventory inv, Component titleIn) {
